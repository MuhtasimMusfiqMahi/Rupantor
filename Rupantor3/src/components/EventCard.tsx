...
export function EventCard({ event, user, accessToken, onUpdate }: EventCardProps) {
  ...
  const handleLike = async () => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/server/events/${event.id}/like`,
        {
          method: 'POST',
          headers: {
  ...
  const handleComment = async () => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/server/events/${event.id}/comment`,
        {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${accessToken}`,
  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/server/events/${event.id}/register`,
        {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${accessToken}`
  ...
  const handleUnregister = async () => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/server/events/${event.id}/unregister`,
        {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${accessToken}`
  ...
  const handleGuestRegister = async () => {
    ...
    try {
      ...
      const url = `https://${projectId}.supabase.co/functions/v1/server/events/${event.id}/register-guest`;
  ...
  const handleGuestUnregister = async () => {
    ...
    setSubmitting(true);
    try {
      const url = `https://${projectId}.supabase.co/functions/v1/server/events/${event.id}/unregister-guest`;
